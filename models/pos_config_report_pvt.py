...
AND product_categ.id = product_tmpl.categ_id
	...
	def generate_excel(self):
		...
		worksheet.set_column('S1:S1',35)
		worksheet.set_column('T1:T1',35)
		...
		for i in range(1):
			...
			if len(record) > 0:
				...
				worksheet.write('F1', 'Descuentos', header_format)
				worksheet.write('G1', 'Total Ventas', header_format)
				worksheet.write('H1', 'Venta Promedio', header_format)
				worksheet.write('I1', '# Productos Vendidos', header_format)
				worksheet.write('J1', '# Promedio de Productos Vendidos diarios', header_format)
				worksheet.write('K1', 'Costo Total', header_format)
				worksheet.write('L1', 'Costo Unitario', header_format)
				worksheet.write('M1', 'Utilidad', header_format)
				worksheet.write('N1', 'A la Mano', header_format)
				worksheet.write('O1', 'Cantidad Virtual', header_format)
				worksheet.write('P1', 'Cantidad Entrante', header_format)
				worksheet.write('Q1', 'Cantidad Saliente', header_format)
				worksheet.write('R1', 'Reglas de Abastecimiento', header_format)
				worksheet.write('S1', 'Abastecimiento Minimo', header_format)
				worksheet.write('T1', 'Abastecimiento Maximo', header_format)
				...
				for value in record:
					...
					worksheet.write(row,col+5 ,  (value.discounts), letter_number)
					worksheet.write(row,col+6 ,  (value.total), letter_number)
					worksheet.write(row,col+7 ,  (value.sale_average_day), letter_number)
					worksheet.write(row,col+8, (value.product_qty) or 0, letter_number)
					worksheet.write(row,col+9 , (value.sold_product_daily_qty), letter_number)
					worksheet.write(row,col+10 ,  value.cost_product, letter_number)
					worksheet.write(row,col+11,  value.product_template_id.standard_price or 0, letter_number)
					worksheet.write(row,col+12 ,  value.utility_product, letter_number)
					worksheet.write(row,col+13,  value.product_qty_stock, letter_number)
					worksheet.write(row,col+14 ,  value.product_virtual_available, letter_number)
					worksheet.write(row,col+15,  value.product_incoming_qty, letter_number)
					worksheet.write(row,col+16,  value.product_outgoing_qty, letter_number)
					worksheet.write(row,col+17 ,  value.product_nbr_reordering_rules, letter_number)
					worksheet.write(row,col+18,  value.product_reordering_min_qty, letter_number)
					worksheet.write(row,col+19,  value.product_reordering_max_qty, letter_number)
					row+=1
